...
class TestTraslator:
    ...
    def test_get_shakespearen_description_success(self, mocker):
        ...
        mocker.patch("poke_restapi.controller.translator.requests.post", return_value=FakeResponse(expected_description))
    ...
    def test_get_pokemon_description_connection_error(self, mocker):
        ...
        with pytest.raises(GenericAPIError):
            description = poke_traslator._get_pokemon_description()
    ...
    def test_get_pokemon_description_invalid_species(self, mocker):
        mocker.patch("poke_restapi.controller.translator.pokebase.pokemon", return_value=FakePokemon("PokemonName", None))
        poke_traslator = Translator("PokemonName")
    ...
    def test_translate_description_500_code(self, mocker):
        ...
        poke_traslator = Translator("PokemonName")
        with pytest.raises(GenericAPIError):
            description = poke_traslator._translate_description("Test description")
